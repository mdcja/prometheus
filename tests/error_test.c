 ...
 * \page error_tests Error Unit Tests
 *
 ...
 *
 * \section error_test_intro Error Unit Tests Introduction
 *
 ...
 * \return the number of integers in a number.
 */
...
/**
 * Get the expected number of characters
 *
 * \param error_code
 * \param message
 * \return total number of characters expected by the error_print() function.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Memory allocation failed error is checked.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Null parameter error is checked.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Not found error is checked.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Invalid capacity error checked.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Not implemented error checked.
 */
 ...
 * This test gets the message given the error code.
 *
 * \post Error greater than ERROR_UNKNOWN checked.
 */
 ...
 *
 * \post Printing ERROR_NO_ERROR is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_UNKNOWN is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_MEMORY_ALLOCATION_FAILED is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_NULL_PARAMETER is checked
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_NOT_FOUND is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_INVALID_CAPACITY is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_NOT_IMPLEMENTED is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_OVERFLOW is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing ERROR_UNDERFLOW is checked.
 */
 ...
 * this test prints all error messages to stderr.
 *
 * \post Printing error greater than 10 is checked.
 */
